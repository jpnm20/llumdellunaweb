...
const translations = {
    es: {
        ...
        // Footer
        "footer.description": "Espacio dedicado al cuidado consciente de la piel, manicuras premium y rituales de bienestar en L'Eliana (anteriormente Edurne Azcona Estética Avanzada) para realzar tu luz propia.",
        ...
        "about.p1": "Nuestra filosofía nace del respeto profundo por tu cuerpo, tu intimidad y tu bienestar. Concebimos Llum de Lluna en nuestro local de L'Eliana (anteriormente Edurne Azcona Estética Avanzada) como un santuario privado de estética donde no existen los ruidos ni las prisas del exterior.",
        ...
        "services.facialTitleHome": "Ritual Facial Renovador",
        "services.facialDescHome": "Cuidado facial profundo de 60 minutos con limpieza, exfoliación, solución desincrustante, extracción, activo concentrado, mascarilla y masaje relajante.",
        "services.tagMani": "Manicura",
        "services.manicuraTitleHome": "Manicura Semipermanente",
        "services.manicuraDescHome": "Cuidado integral de manos y uñas: manicura natural, esmaltado semipermanente de larga duración y refuerzo de grafeno para uñas impecables.",
        ...
        "contact.tag": "Reservas & Sugerencias",
        "contact.title": "¿En qué podemos ayudarte?",
        "contact.desc": "Reserva tu cita online fácilmente a través de Treatwell o envíanos cualquier duda, mejora o sugerencia para seguir perfeccionando nuestro servicio.",
        "contact.formHeader": "Cajón de Sugerencias",
        "contact.formDesc": "Cualquier duda, mejora o sugerencia puede ser escrita aquí. Estaremos encantados de atenderte y seguir mejorando el servicio.",
        "contact.nameLabel": "Nombre Completo",
        "contact.namePlaceholder": "Ej. Sofía Martín",
        "contact.phoneLabel": "Teléfono o Email de Contacto",
        "contact.phonePlaceholder": "Tu número de teléfono o correo",
        "contact.messageLabel": "Tu duda, mejora o sugerencia",
        "contact.messagePlaceholder": "Escribe aquí tu duda, propuesta de mejora o sugerencia...",
        "contact.sendBtn": "Enviar Sugerencia",
        "contact.sendingBtn": "Enviando...",
        "contact.successToast": "¡Gracias {name}! Hemos recibido tu mensaje. Estaremos encantados de escucharte y seguir mejorando nuestro servicio.",
        "contact.errorToast": "Ocurrió un error al enviar el mensaje. Inténtalo de nuevo o escríbenos por WhatsApp.",
        ...
        "contact.treatwellDesc": "¿Quieres agendar tu cita online de forma rápida?",
        "contact.treatwellBtn": "Pincha aquí para reservar cita",
        ...
        "treatments.filterHairSpa": "Spa Capilar",
        ...
        "treatments.groupHairSpa": "Spa Capilar",
        ...
        "treatments.subBodyWood": "Maderoterapia",
        "treatments.subFacialCapillaryCombo": "Combinación con spa capilar",
        "treatments.subCapillaryFacialCombo": "Combinación con faciales",
        ...
        "t.hairDamaged.name": "Tratamiento Capilar para Cabello Dañado",
        ...
        "t.hairRelax.name": "Ritual Capilar Relajación Profunda",
        "t.hairRelax.desc": "Experiencia de bienestar capilar intensiva de 75 minutos diseñada para liberar tensiones acumuladas en el cuero cabelludo, cuello y trapecios, aportando una desconexión y relajación profunda.",
        "t.hairRelax.pre": "Venir con ropa cómoda y sin peinados muy tirantes.",
        "t.hairRelax.post": "Mantener la hidratación y disfrutar de la sensación de ligereza en el cuero cabelludo.",
        ...
        "t.waxM0.name": "Diseño de Cejas (Cera + Pinzas)",
        ...
        "gallery.filterHair": "Capilar",
        "gallery.filterBody": "Corporal",
        "gallery.filterNails": "Manicura & Pedicura",
        ...
        "gallery.card4Desc": "Cuidado facial profundo de 60 minutos con limpieza, exfoliación, extracción y mascarilla.",
        "gallery.card4Category": "FACIAL",
        "gallery.card5Title": "Cabina Corporal & Depilación",
        "gallery.card5Desc": "Espacio amplio a puerta cerrada con música de acompañamiento.",
        "gallery.card6Title": "Cabina Faciales & Capilar",
        "gallery.card6Desc": "Iluminación ambiente durante el tratamiento y música relajante.",
        "gallery.card7Title": "Cabina Corporal & Depilación",
        "gallery.card7Desc": "Iluminación ambiente durante el tratamiento y música de acompañamiento.",
        "gallery.card8Title": "Cabina Faciales & Capilar",
        "gallery.card8Desc": "Espacio privado a puerta cerrada con música relajante.",
        "gallery.card9Title": "Cabina Corporal & Depilación",
        "gallery.card9Desc": "Equipamiento y camilla confort con música de acompañamiento.",
        "gallery.cardFacial1Title": "Tratamiento Facial",
        "gallery.cardFacial1Desc": "Cuidado facial profundo de 60 minutos con limpieza, exfoliación, desincrustante y activo concentrado.",
        "gallery.cardFacial2Title": "Ritual Facial",
        "gallery.cardFacial2Desc": "Masaje facial relajante con técnicas drenantes y reafirmantes para potenciar la luminosidad natural.",
        "gallery.cardFacial3Title": "Tratamiento Facial",
        "gallery.cardFacial3Desc": "Aplicación de cosmética de alta gama tras diagnóstico estético personalizado de la piel.",
        "gallery.cardFacial4Title": "Ritual Facial",
        "gallery.cardFacial4Desc": "Mascarilla oclusiva refrescante e hidratante combinada con masaje relajante cervical y armónico.",
        "gallery.cardFacial5Title": "Ritual Facial",
        "gallery.cardFacial5Desc": "Preparación artesanal y técnica delicada de aplicación de mascarilla para calmar y renovar la tez.",
        "gallery.tapToFlip": "Toca para voltear ↺",
    ...
    va: {
        ...
        // Footer
        "footer.description": "Espai dedicat a la cura conscient de la pell, manicures prèmium i rituals de benestar a L'Eliana (anteriorment Edurne Azcona Estètica Avançada) per a realçar la teua llum pròpia.",
        ...
        "about.p1": "La nostra filosofia naix del respecte profund pel teu cos, la teua intimitat i el teu benestar. Concebem Llum de Lluna en el nostre local de L'Eliana (anteriorment Edurne Azcona Estètica Avançada) com un santuari privat d'estètica on no existeixen els sorolls ni les presses de l'exterior.",
        ...
        "services.tagFacial": "Facial",
        "services.facialTitleHome": "Ritual Facial Renovador",
        "services.facialDescHome": "Cura facial profunda de 60 minuts amb neteja, exfoliació, solució desincrustant, extracció, actiu concentrat, mascareta i massatge relaxant.",
        "services.tagMani": "Manicura",
        "services.manicuraTitleHome": "Manicura Semipermanent",
        "services.manicuraDescHome": "Cura integral de mans i ungles: manicura natural, esmaltat semipermanent de llarga durada i reforç de grafè per a ungles impecables.",
        ...
        // Contact Section (Home)
        "contact.tag": "Reserves i Suggeriments",
        "contact.title": "En què et podem ajudar?",
        "contact.desc": "Reserva la teua cita online fàcilment a través de Treatwell o envia'ns qualsevol dubte, millora o suggeriment per a continuar perfeccionant el nostre servei.",
        "contact.formHeader": "Bústia de Suggeriments",
        "contact.formDesc": "Qualsevol dubte, millora o suggeriment pot ser escrit ací. Estarem encantats d'atendre't i continuar millorant el servei.",
        "contact.nameLabel": "Nom Complet",
        "contact.namePlaceholder": "Ex. Sofia Martín",
        "contact.phoneLabel": "Telèfon o Email de Contacte",
        "contact.phonePlaceholder": "El teu número de telèfon o correu",
        "contact.messageLabel": "El teu dubte, millora o suggeriment",
        "contact.messagePlaceholder": "Escriu ací el teu dubte, proposta de millora o suggeriment...",
        "contact.sendBtn": "Enviar Suggeriment",
        "contact.sendingBtn": "Enviant...",
        "contact.successToast": "Gràcies {name}! Hem rebut el teu missatge. Estarem encantats d'escoltar-te i continuar millorant el nostre servei.",
        "contact.errorToast": "Hi ha hagut un error en enviar el missatge. Intenta-ho de nou o escriu-nos per WhatsApp.",
        ...
        "contact.treatwellDesc": "Vols agendar la teua cita online de manera ràpida?",
        "contact.treatwellBtn": "Prem ací per a reservar cita",
        ...
        "treatments.filterFacial": "Facial",
        "treatments.filterHairSpa": "Spa Capil·lar",
        "treatments.filterBody": "Corporal",
        ...
        "treatments.groupFacial": "Facial",
        "treatments.groupHairSpa": "Spa Capil·lar",
        "treatments.groupBody": "Corporal",
        ...
        "treatments.subBodyWood": "Maderoteràpia",
        "treatments.subFacialCapillaryCombo": "Combinació amb spa capil·lar",
        "treatments.subCapillaryFacialCombo": "Combinació amb facials",
        "treatments.subManicure": "Manicura",
        "treatments.subPedicure": "Pedicura",
        ...
        "t.hairDamaged.name": "Tractament Capil·lar per a Cabell Danyat",
        ...
        "t.hairRelax.name": "Ritual Capil·lar Relaxació Profunda",
        "t.hairRelax.desc": "Experiència de benestar capil·lar intensiva de 75 minuts dissenyada per a alliberar tensions acumulades al cuir cabellut, coll i trapezis, aportant una desconnexió i relaxació profunda.",
        "t.hairRelax.pre": "Vindre amb roba còmoda i sense pentinats molt tirants.",
        "t.hairRelax.post": "Mantindre la hidratació i gaudir de la sensació de lleugeresa al cuir cabellut.",
        ...
        "t.waxM0.name": "Disseny de Celles (Cera + Pinces)",
        ...
        "gallery.filterFacial": "Facial",
        "gallery.filterHair": "Capil·lar",
        "gallery.filterBody": "Corporal",
        "gallery.filterNails": "Manicura i Pedicura",
        ...
        "gallery.card4Title": "Ritual Facial Renovador",
        "gallery.card4Desc": "Cura facial profunda de 60 minuts amb neteja, exfoliació, extracció i mascareta.",
        "gallery.card4Category": "FACIAL",
        "gallery.card5Title": "Cabina Corporal i Depilació",
        "gallery.card5Desc": "Espai àmpli a porta tancada amb música d'acompanyament.",
        "gallery.card6Title": "Cabina Facials i Capil·lar",
        "gallery.card6Desc": "Il·luminació ambient durant el tractament i música relaxant.",
        "gallery.card7Title": "Cabina Corporal i Depilació",
        "gallery.card7Desc": "Il·luminació ambient durant el tractament i música d'acompanyament.",
        "gallery.card8Title": "Cabina Facials i Capil·lar",
        "gallery.card8Desc": "Espai privat a porta tancada amb música relaxant.",
        "gallery.card9Title": "Cabina Corporal i Depilació",
        "gallery.card9Desc": "Equipament i camilla confort amb música d'acompanyament.",
        "gallery.cardFacial1Title": "Tractament Facial",
        "gallery.cardFacial1Desc": "Cura facial profunda de 60 minuts amb neteja, exfoliació, desincrustant i actiu concentrat.",
        "gallery.cardFacial2Title": "Ritual Facial",
        "gallery.cardFacial2Desc": "Massatge facial relaxant amb tècniques drenants i reafirmants per a potenciar la lluminositat natural.",
        "gallery.cardFacial3Title": "Tractament Facial",
        "gallery.cardFacial3Desc": "Aplicació de cosmètica d'alta gamma després de diagnòstic estètic personalitzat de la pell.",
        "gallery.cardFacial4Title": "Ritual Facial",
        "gallery.cardFacial4Desc": "Mascareta oclusiva refrescant i hidratant combinada amb massatge relaxant cervical i harmònic.",
        "gallery.cardFacial5Title": "Ritual Facial",
        "gallery.cardFacial5Desc": "Preparació artesanal i tècnica delicada d'aplicació de mascareta per a calmar i renovar la tez.",
        "gallery.tapToFlip": "Toca per a girar ↺",
    ...
    en: {
        ...
        // Footer
        "footer.description": "A sanctuary dedicated to conscious skincare, premium manicures, and wellness rituals in L'Eliana (formerly Edurne Azcona Estética Avanzada) to highlight your natural glow.",
        ...
        "footer.tagline": "Beauty & Wellness",
        "footer.language": "Language:",

        // Hero Section (Home)
        "hero.subtitle": "Beauty Center in L'Eliana",
        "hero.h1": "Beauty Center in L'Eliana",
        ...
        "privacy.desc": "A boutique beauty center in L'Eliana crafted to be an intimate sanctuary: peaceful, private, and tailored for your total relaxation without interruptions.",
        ...
        "about.p1": "Our philosophy stems from deep respect for your body, privacy, and well-being. We conceived Llum de Lluna in our L'Eliana center (formerly Edurne Azcona Estética Avanzada) as a private beauty sanctuary where outside noise and haste do not exist.",
        ...
        "services.tagFacial": "Facial",
        "services.facialTitleHome": "Renewal Facial Ritual",
        "services.facialDescHome": "Comprehensive 60-minute facial care featuring deep cleansing, exfoliation, extractions, active ingredients, soothing mask, and relaxation massage.",
        "services.tagMani": "Manicure",
        "services.manicuraTitleHome": "Gel Polish Manicure",
        "services.manicuraDescHome": "Comprehensive hand and nail care: natural manicure, long-lasting gel polish, and graphene structural reinforcement for flawless nails.",
        "services.tagHairSpa": "Spa Capilar",
        ...
        // Contact Section (Home)
        "contact.tag": "Bookings & Suggestions",
        "contact.title": "How Can We Help You?",
        "contact.desc": "Book your appointment online easily via Treatwell, or send us any questions, improvements, or suggestions to help us keep improving our service.",
        "contact.formHeader": "Suggestion Box",
        "contact.formDesc": "Any questions, improvements, or suggestions can be written here. We will be delighted to assist you and keep improving our service.",
        "contact.nameLabel": "Full Name",
        "contact.namePlaceholder": "E.g. Sofia Martin",
        "contact.phoneLabel": "Contact Phone or Email",
        "contact.phonePlaceholder": "Your phone number or email",
        "contact.messageLabel": "Your Question, Improvement, or Suggestion",
        "contact.messagePlaceholder": "Type your question, improvement idea, or suggestion here...",
        "contact.sendBtn": "Submit Suggestion",
        "contact.sendingBtn": "Sending...",
        "contact.successToast": "Thank you {name}! We have received your message. We are delighted to hear from you and keep improving our service.",
        "contact.errorToast": "An error occurred while sending the message. Please try again or reach us via WhatsApp.",
        ...
        "contact.treatwellDesc": "Want to book your appointment online quickly?",
        "contact.treatwellBtn": "Click here to book an appointment",

        // Treatments Page
        "treatments.pageTag": "Service Menu in L'Eliana",
        "treatments.pageTitle": "Beauty Treatments & Rates in L'Eliana",
        "treatments.pageDesc": "We offer personalized solutions and beauty rituals in private rooms in L'Eliana. Click on each category to view detailed treatment descriptions and prices.",
        ...
        "treatments.subBodyWood": "Wood Therapy",
        "treatments.subFacialCapillaryCombo": "Combination with Hair Spa",
        "treatments.subCapillaryFacialCombo": "Combination with Facials",
        ...
        "t.facial1.desc": "Comprehensive 60-minute facial treatment: deep cleansing, exfoliation, desincrustation solution, extraction (optional hair removal) and concentrated active ingredient after skin assessment. Includes hydrating cream with facial massage, occlusive gel mask, cervical, chest and arm massage, sunscreen and lip balm.",
        ...
        "t.facial2.desc": "Comprehensive 60-minute facial treatment: deep cleansing, exfoliation, and concentrated active ingredient after skin assessment. Includes hydrating cream with facial massage, occlusive gel mask, cervical, chest and arm massage, sunscreen and lip balm.",
        ...
        "t.facialVitC.desc": "Comprehensive 60-minute facial treatment: deep cleansing, exfoliation, desincrustation solution, extraction (optional hair removal) and concentrated active ingredient after skin assessment. Includes hydrating cream with facial massage, occlusive gel mask, cervical, chest and arm massage, sunscreen and lip balm.",
        ...
        "t.facialAntiage.desc": "Comprehensive 60-minute facial treatment: deep cleansing, exfoliation, desincrustation solution, extraction (optional hair removal) and concentrated active ingredient after skin assessment. Includes hydrating cream with facial massage, occlusive gel mask, cervical, chest and arm massage, sunscreen and lip balm.",
        ...
        "t.facialRefresh.desc": "Comprehensive 60-minute facial treatment: deep cleansing, exfoliation, desincrustation solution, extraction (optional hair removal) and concentrated active ingredient after skin assessment. Includes hydrating cream with facial massage, occlusive gel mask, cervical, chest and arm massage, sunscreen and lip balm.",
        ...
        "t.hairDamaged.name": "Capillary Treatment for Damaged Hair",
        ...
        "t.hairRelax.name": "Deep Relaxation Hair Ritual",
        "t.hairRelax.desc": "Intensive 75-minute hair wellness experience designed to relieve accumulated tension in the scalp, neck, and shoulders, delivering deep relaxation and peace.",
        "t.hairRelax.pre": "Wear comfortable clothing and avoid tight hairstyles prior to the appointment.",
        "t.hairRelax.post": "Stay hydrated and enjoy the feeling of lightness throughout your scalp.",
        ...
        "t.body1.desc": "Personalized skin assessment followed by a complete body wood therapy session on arms, abdomen, back, buttocks, and legs to evaluate and activate the circulatory and lymphatic system.",
        ...
        "t.pedi5.desc": "Cosmetic reconstruction and leveling of damaged toe nail using polygel *(add-on to a primary service)*.",
        ...
        "t.waxM0.name": "Eyebrows Hair Removal (Wax + Tweezers)",
        ...
        "gallery.filterFacial": "Facial",
        "gallery.filterHair": "Hair",
        "gallery.filterBody": "Body",
        "gallery.filterNails": "Manicure & Pedicure",
        ...
        "gallery.card4Title": "Renewal Facial Ritual",
        "gallery.card4Desc": "Comprehensive 60-minute facial care featuring deep cleansing, exfoliation, extractions, and mask.",
        "gallery.card4Category": "FACIAL",
        "gallery.card5Title": "Body & Hair Removal Cabin",
        "gallery.card5Desc": "Spacious closed-door space with background music.",
        "gallery.card6Title": "Facial & Hair Spa Cabin",
        "gallery.card6Desc": "Ambient lighting during treatment and relaxing music.",
        "gallery.card7Title": "Body & Hair Removal Cabin",
        "gallery.card7Desc": "Ambient lighting during treatment and background music.",
        "gallery.card8Title": "Facial & Hair Spa Cabin",
        "gallery.card8Desc": "Private closed-door space with relaxing music.",
        "gallery.card9Title": "Body & Hair Removal Cabin",
        "gallery.card9Desc": "Treatment table & equipment with background music.",
        "gallery.cardFacial1Title": "Facial Treatment",
        "gallery.cardFacial1Desc": "Comprehensive 60-minute facial care featuring deep cleansing, exfoliation, extractions, and active ingredients.",
        "gallery.cardFacial2Title": "Facial Ritual",
        "gallery.cardFacial2Desc": "Relaxing facial massage with draining and firming techniques to boost natural skin radiance.",
        "gallery.cardFacial3Title": "Facial Treatment",
        "gallery.cardFacial3Desc": "High-end cosmetics application tailored to your personalized skin assessment.",
        "gallery.cardFacial4Title": "Facial Ritual",
        "gallery.cardFacial4Desc": "Occlusive gel mask providing deep hydration combined with soothing cervical massage.",
        "gallery.cardFacial5Title": "Facial Ritual",
        "gallery.cardFacial5Desc": "Delicate application of specialized face masks to soothe, hydrate, and renew your complexion.",
        "gallery.tapToFlip": "Tap to flip ↺",
